...
export const registrationTemplate = (fullName: string, OTP: number) => {
  return template(` <div style="box-sizing: border-box; background-color:#101217; max-width: 600px; border-radius: 24px; width: 100%; margin: 30px auto; padding: 16px;">
